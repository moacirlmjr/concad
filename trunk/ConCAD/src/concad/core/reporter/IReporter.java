...
public interface IReporter {
	 ...
	 * 
	 * @param resources
	 *            The list of resources that will have all of its old problems
	 *            deleted.
	 */
	 ...
	 *            The data flow of the vulnerability, from where it started to
	 *            where it finished. {@link DataFlow}.
	 */
